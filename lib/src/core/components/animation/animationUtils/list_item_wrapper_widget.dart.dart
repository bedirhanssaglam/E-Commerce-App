...
class ListItemWrapperWidget extends StatefulWidget {
  const ListItemWrapperWidget({
    Key? key,
    required this.child,
  ...
  @override
  State<ListItemWrapperWidget> createState() => _ListItemWrapperWidgetState();
}

class _ListItemWrapperWidgetState extends State<ListItemWrapperWidget>
